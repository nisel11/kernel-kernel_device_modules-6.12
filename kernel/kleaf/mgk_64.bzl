...
def get_overlay_modules_list():
    if "moto" in DEFCONFIG_OVERLAYS:
        ...
        mgk_64_kleaf_modules.append("//motorola/kernel/modules/drivers/moto_mm/mm:moto_mm")
        ...
        mgk_64_kleaf_modules.append("//motorola/kernel/modules/drivers/moto_sched:moto_sched")
    ...
    if "bogota" in DEFCONFIG_OVERLAYS:
        ...
        mgk_64_kleaf_modules.append("//motorola/kernel/modules/drivers/fm:fm_ctrl")
        ...
        mgk_64_kleaf_modules.append("//motorola/kernel/modules/drivers/power/mmi_pephv:mmi_pephv")
    ...
    if "taipei" in DEFCONFIG_OVERLAYS:
        ...
        mgk_64_kleaf_modules.append("//motorola/kernel/modules/drivers/nfc/sec_nfc:sec_nfc")
