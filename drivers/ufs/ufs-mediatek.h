...
#define REG_UFS_MMIO_DBG_UIC_CMD    0x1E0
#define REG_UFS_MMIO_DBG_UIC_ID     0x1E4
#define REG_UFS_MMIO_DBG_UIC_WR_VAL 0x1E8
#define REG_UFS_MMIO_DBG_UIC_RD_VAL 0x1EC
#define REG_UFS_MMIO_DBG_UIC_RESULT 0x1F0
