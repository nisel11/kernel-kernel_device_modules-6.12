...
#define DISP_SLOT_OVL_STATUS(n)                                                 \
        (DISP_SLOT_SKIP_CHECK_TRIGGER + 0x4 + (0x4 * (n)))
...
#define DISP_SLOT_DSI_RX_TRIG_STA	(DISP_SLOT_READ_DDIC_BASE_END)
...
#define DISP_SLOT_CUR_HRT_VAL_DMRR_STASH (DISP_SLOT_CUR_HRT_VAL_DMRR + 0x4)
