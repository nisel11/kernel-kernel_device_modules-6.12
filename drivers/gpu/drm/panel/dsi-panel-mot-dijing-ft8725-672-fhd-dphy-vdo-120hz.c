...
enum panel_version {
        PANEL_V0=3,		//EVT=1; DVT1=2; DVT2,PVT0=3
        PANEL_V1,		//PVT formal
};
...
static void lcm_panel_init(struct lcm *ctx)
{
  ...
  if (PANEL_V0 == ctx->version) {
	pr_info("disp: %s+, dijing_ft8725 init v0 for evt/dvt/pvt0\n", __func__);
	...
	lcm_dcs_write_seq_static(ctx,0x00,0x80);
	lcm_dcs_write_seq_static(ctx,0xC0,0x00,0x4F,0x00,0x1E,0x00,0x14);
	...
	lcm_dcs_write_seq_static(ctx,0xC0,0x00,0xBC,0x00,0x1E,0x14);
	lcm_dcs_write_seq_static(ctx,0x00,0xC1);
	lcm_dcs_write_seq_static(ctx,0xC0,0x00,0x94,0x00,0x79,0x00,0x63,0x00,0xB6);
	lcm_dcs_write_seq_static(ctx,0x00,0x70);
	lcm_dcs_write_seq_static(ctx,0xC0,0x00,0xB1,0x00,0x1E,0x00,0x14);
	lcm_dcs_write_seq_static(ctx,0x00,0xA3);
	lcm_dcs_write_seq_static(ctx,0xC1,0x00,0x71,0x00,0x41,0x00,0x02);
	...
	lcm_dcs_write_seq_static(ctx,0x00,0x90);
	lcm_dcs_write_seq_static(ctx,0xCE,0x00,0xA7,0x0E,0x18,0x00,0xA7,0x80,0xFF,0xFF,0x00,0x13,0x88,0x18,0x0F,0x0F);
	lcm_dcs_write_seq_static(ctx,0x00,0xA0);
	...
	lcm_dcs_write_seq_static(ctx,0xCE,0x03,0x01,0xB0,0x02,0xCF,0x02,0xCF,0x00,0x00,0x00,0x00);
	lcm_dcs_write_seq_static(ctx,0x00,0xF1);
	lcm_dcs_write_seq_static(ctx,0xCE,0x23,0x12,0x11,0x00,0xBB,0x01,0x16,0x01,0x27);
	lcm_dcs_write_seq_static(ctx,0x00,0xB0);
	lcm_dcs_write_seq_static(ctx,0xCF,0x01,0x01,0x4C,0x50);
	lcm_dcs_write_seq_static(ctx,0x00,0xB5);
	lcm_dcs_write_seq_static(ctx,0xCF,0x05,0x06,0xFC,0x00);
	...
	lcm_dcs_write_seq_static(ctx,0x00,0x70);
	lcm_dcs_write_seq_static(ctx,0xCF,0x00,0x00,0xC5,0xC9,0x05,0x05,0x75,0x79);
	lcm_dcs_write_seq_static(ctx,0x00,0xD1);
	...
	lcm_dcs_write_seq_static(ctx,0x00,0x80);
	lcm_dcs_write_seq_static(ctx,0xC2,0x84,0x00,0x02,0x8C,0x83,0x00,0x02,0x8C);
	lcm_dcs_write_seq_static(ctx,0x00,0xA0);
	lcm_dcs_write_seq_static(ctx,0xC2,0x82,0x04,0x00,0x02,0x8C,0x81,0x04,0x00,0x02,0x8C,0x80,0x04,0x00,0x02,0x8C);
	lcm_dcs_write_seq_static(ctx,0x00,0xB0);
	...
	lcm_dcs_write_seq_static(ctx,0xC0,0x00,0x00,0x00,0x00,0x11,0x11,0x11,0x06);
	lcm_dcs_write_seq_static(ctx,0x00,0x76);
	lcm_dcs_write_seq_static(ctx,0xC0,0x01,0x01,0x01,0x01,0x21,0x21,0x21,0x08);
	lcm_dcs_write_seq_static(ctx,0x00,0xA3);
	lcm_dcs_write_seq_static(ctx,0xCE,0x00,0x00,0x00,0x00,0x11,0x06);
	...
	lcm_dcs_write_seq_static(ctx,0x00,0xC4);
	lcm_dcs_write_seq_static(ctx,0xC5,0xFF,0xFF,0x55);
	lcm_dcs_write_seq_static(ctx,0x00,0x8C);
	lcm_dcs_write_seq_static(ctx,0xC3,0x01,0x00,0x10);
	lcm_dcs_write_seq_static(ctx,0x00,0x80);
	lcm_dcs_write_seq_static(ctx,0xA7,0x06);
	lcm_dcs_write_seq_static(ctx,0x00,0xB1);
	lcm_dcs_write_seq_static(ctx,0xC5,0x7A);
	lcm_dcs_write_seq_static(ctx,0x00,0xB4);
	lcm_dcs_write_seq_static(ctx,0xC5,0x7A);
  }
  else {
	//PVT formal
	pr_info("disp: %s+, dijing_ft8725 init v1 pvt\n", __func__);
	...
	if(chosen) {
		...
		if (!rc) {
			if (tmp && tmp <= PANEL_V0) {
				...
				pr_info("dijing get v0 panel_ver:%d tmp=%d\n", ctx->version, tmp);
			}
		}
		else
