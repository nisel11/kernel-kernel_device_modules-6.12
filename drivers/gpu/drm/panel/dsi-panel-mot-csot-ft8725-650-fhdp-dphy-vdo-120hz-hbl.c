...
static void csot_panel_init(struct csot *ctx)
{
	...
	csot_dcs_write_seq_static(ctx,0xC0,0x4A);
	...
	csot_dcs_write_seq_static(ctx,0xCE,0x0F,0xA0);
	csot_dcs_write_seq_static(ctx,0x00,0xE2);
	csot_dcs_write_seq_static(ctx,0xCE,0x01,0xCA);
	csot_dcs_write_seq_static(ctx,0x00,0x85);
	csot_dcs_write_seq_static(ctx,0xB4,0x77);
	csot_dcs_write_seq_static(ctx,0x00,0x87);
	csot_dcs_write_seq_static(ctx,0xC4,0x08);
	csot_dcs_write_seq_static(ctx,0x00,0x81);
	csot_dcs_write_seq_static(ctx,0xA4,0x23,0x23);
	csot_dcs_write_seq_static(ctx,0x00,0x90);
	csot_dcs_write_seq_static(ctx,0xE9,0x50);
	csot_dcs_write_seq_static(ctx,0x00,0x87);
	csot_dcs_write_seq_static(ctx,0xF5,0x00);
	csot_dcs_write_seq_static(ctx,0x00,0xBE);
	csot_dcs_write_seq_static(ctx,0xC5,0xC0,0xC0);
	csot_dcs_write_seq_static(ctx,0x00,0xE0);
	csot_dcs_write_seq_static(ctx,0xCE,0x00);
	csot_dcs_write_seq_static(ctx,0x00,0xFC);
	csot_dcs_write_seq_static(ctx,0xC0,0x00,0x16);
	csot_dcs_write_seq_static(ctx,0x00,0x00);
...
static void csot_remove(struct mipi_dsi_device *dsi)
{
