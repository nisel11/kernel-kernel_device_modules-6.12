...
static char *pwr_ctrl_str[PW_MAX_COUNT] = {
	...
	[PW_REG_CAM_SRCCLKENA_MASK_B] = "reg_cam_srcclkena_mask_b",
	...
	[PW_REG_IPE_APSRC_REQ_MASK_B] = "reg_ipe_apsrc_req_mask_b",
	[PW_REG_IPE_DDREN_REQ_MASK_B] = "reg_ipe_ddren_req_mask_b",
	[PW_REG_IPE_EMI_REQ_MASK_B] = "reg_ipe_emi_req_mask_b",
	[PW_REG_IPE_INFRA_REQ_MASK_B] = "reg_ipe_infra_req_mask_b",
	[PW_REG_IPE_PMIC_REQ_MASK_B] = "reg_ipe_pmic_req_mask_b",
	[PW_REG_IPE_SRCCLKENA_MASK_B] = "reg_ipe_srcclkena_mask_b",
	[PW_REG_IPE_VRF18_REQ_MASK_B] = "reg_ipe_vrf18_req_mask_b",
	...
	[PW_REG_UFS_VCORE_REQ_MASK_B] = "reg_ufs_vcore_req_mask_b",
...
static int __init mt6858_dbg_device_initcall(void)
{
	int ret;
...
static int __init mt6858_dbg_late_initcall(void)
{
...
int __init mt6858_dbg_init(void)
{
	int ret = 0;

	ret = mt6858_dbg_device_initcall();
	if (ret)
		goto mt6858_dbg_init_fail;

	ret = mt6858_dbg_late_initcall();
	if (ret)
		goto mt6858_dbg_init_fail;

	return 0;

mt6858_dbg_init_fail:
	return -EAGAIN;
}

void __exit mt6858_dbg_exit(void)
{
...
module_init(mt6858_dbg_init);
module_exit(mt6858_dbg_exit);

MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("mt6858 low power debug module");
