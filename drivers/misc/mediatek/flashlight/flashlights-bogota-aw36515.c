...
static const unsigned char aw36515_torch_level[AW36515_LEVEL_NUM] = {
	0x00, 0x09, 0x13, 0x19, 0x28, 0x32, 0x3D, 0x00, 0x00, 0x00,// I(mA) = level*1.96+0.98    0 20 40 50 80 100 120 level3 for japan machine
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00};

static const unsigned char aw36515_flash_level[AW36515_LEVEL_NUM] = {
	0x02, 0x0C, 0x16, 0x20, 0x2A, 0x34, 0x3E, 0x49, 0x53, 0x5D,
	0x67, 0x71, 0x7B, 0x85, 0x8F, 0x99, 0xA3, 0xAE, 0xB8, 0xC2,
	0xCC, 0xD6, 0xE0, 0xEA, 0xF4, 0xFF}; // I(mA) = level*7.83+3.91  0xFF = 2000mA
...
aw36515_i2c_probe(struct i2c_client *client)
{
	...
	pr_info("%s AW36515_DEVICES_ID 0x%02x\n", __func__, dev_id);
	...
	if (flashlight_dev_register(BOGOTA_AW36515_NAME, &aw36515_ops)) {
...
static void aw36515_i2c_remove(struct i2c_client *client)
{
	...
	flashlight_dev_unregister(BOGOTA_AW36515_NAME);
...
static const struct i2c_device_id aw36515_i2c_id[] = {
	{BOGOTA_AW36515_NAME, 0},
	{}
};

#ifdef CONFIG_OF
static const struct of_device_id aw36515_i2c_of_match[] = {
	{.compatible = BOGOTA_AW36515_DTNAME_I2C},
	{},
};
#endif
...
static void aw36515_remove(struct platform_device *dev)
{
	pr_info("AW36515 Remove start.\n");
...
static const struct of_device_id aw36515_of_match[] = {
	{.compatible = BOGOTA_AW36515_DTNAME},
	{},
};
