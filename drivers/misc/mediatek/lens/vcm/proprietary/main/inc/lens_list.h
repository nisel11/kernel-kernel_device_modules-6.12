...
//Begin: Add lens driver interface for Taipei
#define MOT_CANCUNF_AW86006VCMYOVA_SetI2Cclient MOT_CANCUNF_AW86006VCMYOVAAF_SetI2Cclient
#define MOT_CANCUNF_AW86006VCMYOVA_Ioctl MOT_CANCUNF_AW86006VCMYOVAAF_Ioctl
#define MOT_CANCUNF_AW86006VCMYOVA_Release MOT_CANCUNF_AW86006VCMYOVAAF_Release
#define MOT_CANCUNF_AW86006VCMYOVA_PowerDown MOT_CANCUNF_AW86006VCMYOVAAF_PowerDown
#define MOT_CANCUNF_AW86006VCMYOVA_GetFileName MOT_CANCUNF_AW86006VCMYOVAAF_GetFileName
extern int MOT_CANCUNF_AW86006VCMYOVAAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long MOT_CANCUNF_AW86006VCMYOVAAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
				unsigned long a_u4Param);
extern int MOT_CANCUNF_AW86006VCMYOVAAF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int MOT_CANCUNF_AW86006VCMYOVAAF_PowerDown(struct i2c_client *pstAF_I2Cclient,
				int *pAF_Opened);
extern int MOT_CANCUNF_AW86006VCMYOVAAF_GetFileName(unsigned char *pFileName);
//End
extern int aw86006_ois_init(struct i2c_client *pstI2Cclient);
#endif

//Begin: Add lens driver interface for Bogota
#define MOT_BOGOTA_GT9764_SetI2CClient MOT_BOGOTA_GT9764AF_SetI2Cclient
#define MOT_BOGOTA_GT9764_Ioctl MOT_BOGOTA_GT9764AF_Ioctl
#define MOT_BOGOTA_GT9764_Release MOT_BOGOTA_GT9764AF_Release
#define MOT_BOGOTA_GT9764_PowerDown MOT_BOGOTA_GT9764AF_PowerDown
#define MOT_BOGOTA_GT9764_GetFileName MOT_BOGOTA_GT9764AF_GetFileName
extern int MOT_BOGOTA_GT9764AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long MOT_BOGOTA_GT9764AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
				unsigned long a_u4Param);
extern int MOT_BOGOTA_GT9764AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int MOT_BOGOTA_GT9764AF_PowerDown(struct i2c_client *pstAF_I2Cclient,
				int *pAF_Opened);
extern int MOT_BOGOTA_GT9764AF_GetFileName(unsigned char *pFileName);
//End
