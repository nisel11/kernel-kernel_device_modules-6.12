	...
	if (((IrqStatus & SOF_INT_ST) && isStagger == 0) ||
		...
		if (IspInfo.DebugMask & ISP_DBG_INT) {
			...
			if (sec_on)
				...
				IRQ_LOG_KEEPER(
				module, m_CurrentPPB, _LOG_INF,
				"%s,%s,CAM_%c P1_SOF_%d_%d(0x%08x_0x%08x,0x%08x_0x%08x,0x%08x,0x%08x,0x%x/0x%x),int_us:%d,FBC:0x%08x,cq:0x%08x_0x%08x 0x%08x_0x%08x 0x%08x_0x%08x,Don(0x%08x_0x%08x 0x%08x_0x%08x,0x%08x_0x%08x 0x%08x_0x%08x),DMA(0x%x_0x%x,0x%x_0x%x,0x%x_0x%x,0x%x_0x%x,0x%x_0x%x,0x%x_0x%x),CTL_EN(0x%x_0x%x 0x%x_0x%x 0x%x_0x%x),CTL_EN2(0x%x_0x%x 0x%x_0x%x 0x%x_0x%x), AFO(0x%x), AAHO(0x%x), LTMSO(0x%x_0x%x 0x%x_0x%x), LCESHO(0x%x_0x%x 0x%x_0x%x), TSFSO(0x%x_0x%x 0x%x_0x%x), LSCI(0x%x_0x%x)\n",
				...
				(unsigned int)ISP_RD32(CAM_REG_AAHO_BASE_ADDR(ISP_CAM_A_IDX)),
				(unsigned int)ISP_RD32(CAM_REG_LTMSO_BASE_ADDR(ISP_CAM_A_IDX)),
				(unsigned int)ISP_RD32(CAM_REG_LTMSO_BASE_ADDR(ISP_CAM_A_INNER_IDX)),
				(unsigned int)ISP_RD32(CAM_REG_LTMSO_BASE_ADDR(ISP_CAM_B_IDX)),
				(unsigned int)ISP_RD32(CAM_REG_LTMSO_BASE_ADDR(ISP_CAM_B_INNER_IDX)),
				(unsigned int)ISP_RD32(CAM_REG_LCESHO_BASE_ADDR(ISP_CAM_A_IDX)),
				(unsigned int)ISP_RD32(CAM_REG_LCESHO_BASE_ADDR(ISP_CAM_A_INNER_IDX)),
				(unsigned int)ISP_RD32(CAM_REG_LCESHO_BASE_ADDR(ISP_CAM_B_IDX)),
				(unsigned int)ISP_RD32(CAM_REG_LCESHO_BASE_ADDR(ISP_CAM_B_INNER_IDX)),
				(unsigned int)ISP_RD32(CAM_REG_TSFSO_BASE_ADDR(ISP_CAM_A_IDX)),
				(unsigned int)ISP_RD32(CAM_REG_TSFSO_BASE_ADDR(ISP_CAM_A_INNER_IDX)),
				(unsigned int)ISP_RD32(CAM_REG_TSFSO_BASE_ADDR(ISP_CAM_B_IDX)),
				(unsigned int)ISP_RD32(CAM_REG_TSFSO_BASE_ADDR(ISP_CAM_B_INNER_IDX)),
				(unsigned int)ISP_RD32(CAM_REG_LSCI_BASE_ADDR(ISP_CAM_A_IDX)),
				(unsigned int)ISP_RD32(CAM_REG_LSCI_BASE_ADDR(ISP_CAM_B_IDX)));
			}
