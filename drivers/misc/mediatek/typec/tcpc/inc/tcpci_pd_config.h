...
#undef CONFIG_TYPEC_DIRECT_CHARGE
#define CONFIG_TYPEC_DIRECT_CHARGE	1
...
#define CONFIG_USB_PD_SAFE0V_DELAY	40
...
#define CONFIG_USB_PD_CUSTOM_VDM_TOUT	475
#endif	/* CONFIG_USB_PD_CUSTOM_VDM_TOUT */

#ifndef CONFIG_USB_PD_VCONN_READY_TOUT
#define CONFIG_USB_PD_VCONN_READY_TOUT		10
