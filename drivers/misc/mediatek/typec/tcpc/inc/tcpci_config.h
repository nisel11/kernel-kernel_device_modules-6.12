...
#ifndef CONFIG_DISABLE_SUPPORT_MMI_ADAPTER
#define CONFIG_SUPPORT_MMI_ADAPTER
#endif //CONFIG_DISABLE_SUPPORT_MMI_ADAPTER
...
#define CONFIG_TYPEC_CAP_EXT_DISCHARGE		1
...
#define CONFIG_WD_PROTECT_RETRY_COUNT	1
