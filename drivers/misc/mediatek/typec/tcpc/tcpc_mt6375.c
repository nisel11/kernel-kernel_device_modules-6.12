...
#define MT6375_SFT_VBUS_TO_CC1	(6)
...
static int mt6375_set_vbus_short_cc(struct tcpc_device *tcpc,
				    bool cc1, bool cc2)
{
	struct mt6375_tcpc_data *ddata = tcpc_get_dev_data(tcpc);
	u8 val = 0;
	...
	mt6375_write8(ddata, MT6375_REG_MTINT3, MT6375_MSK_VBUS_TO_CC);

	val = (cc1 ? MT6375_MSK_CMPEN_VBUS_TO_CC1 : 0) |
		(cc2 ? MT6375_MSK_CMPEN_VBUS_TO_CC2 : 0);

	return mt6375_update_bits(ddata, MT6375_REG_FRS_CTRL2,
...
static void mt6375_vbus_to_cc_dwork_handler(struct work_struct *work)
{
	...
	data = (data & MT6375_MSK_VBUS_TO_CC) >> MT6375_SFT_VBUS_TO_CC1;
...
static int mt6375_vbus_to_cc_irq_handler(struct mt6375_tcpc_data *ddata)
{
...
static struct irq_mapping_tbl mt6375_vend_irq_mapping_tbl[] = {
	...
	MT6375_IRQ_MAPPING(22, 3, vbus_to_cc),	/* vbus_to_cc1 */
	MT6375_IRQ_MAPPING(23, 3, vbus_to_cc),	/* vbus_to_cc2 */
...
static struct tcpc_ops mt6375_tcpc_ops = {
	...
	.set_vbus_short_cc = mt6375_set_vbus_short_cc,
