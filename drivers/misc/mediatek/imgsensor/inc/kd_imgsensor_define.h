...
enum ACDK_SENSOR_FEATURE_ENUM {
	...
	SENSOR_FEATURE_GET_GAIN_RATIO_BY_SCENARIO,
	SENSOR_FEATURE_GET_DCG_GAIN_MODE_BY_SCENARIO,
...
enum IMGSENSOR_HDR_SUPPORT_TYPE_ENUM {
	...
	HDR_SUPPORT_DCG = HDR_SUPPORT_STAGGER_MAX,
};
...
enum IMGSENSOR_HDR_MODE_ENUM {
	...
	HDR_RAW_DCG_COMPOSE_RAW12,
	HDR_RAW_DCG_COMPOSE_RAW14,
/* sensor output is 12bit, but ISP process 10bit */
	HDR_RAW_DCG_COMPOSE_FAKE_RAW10,
};
