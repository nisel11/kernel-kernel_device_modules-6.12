...
static const struct proc_ops lct_proc_tp_grip_area_fops = {
	.proc_open		= lct_proc_tp_grip_area_open,
	.proc_read		= lct_proc_tp_grip_area_read,
	.proc_write		= lct_proc_tp_grip_area_write,
};
#else
...
int init_lct_tp_grip_area(set_screen_angle_callback set_fun, get_screen_angle_callback get_fun)
{
	...
	lct_tp_p->proc_entry_tp_grip_area = proc_create_data(TP_GRIP_AREA_NAME, 0666, NULL, &lct_proc_tp_grip_area_fops, NULL);
