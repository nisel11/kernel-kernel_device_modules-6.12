...
static bool lct_tp_data_dump_flag = false;
#endif
...
static int fts_test_entry(char *ini_file_name)
{
    ...
    if (true == fts_test_start()) {
...
#if defined(TEST_SAVE_FAIL_RESULT) && TEST_SAVE_FAIL_RESULT
        {
            ...
            fts_ftest->tv.tv_sec = ts.tv_sec;
            fts_ftest->tv.tv_usec = ts.tv_nsec / 1000;
        }
#endif
    }
...
#ifdef FTS_TP_DATA_DUMP_EN
bool lct_tp_get_dump_flag(void)
{
    return lct_tp_data_dump_flag;
}
