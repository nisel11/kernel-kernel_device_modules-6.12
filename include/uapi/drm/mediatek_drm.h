...
#define DRM_MTK_FRAME_SUBMIT 0x3F
...
/* panel feature */
#define DRM_SET_PANEL_FEATURE 0x4d
#define DRM_GET_PANEL_FEATURE 0x4E
...
enum MTK_DRM_DISP_FEATURE {
	...
	DRM_DISP_FEATURE_FRAME_SUBMIT = 0x00020000,
	DRM_DISP_FEATURE_RETRIGGER = 0x00040000,
	DRM_DISP_FEATURE_PROP_INHERITANCE = 0x00080000,
	DRM_DISP_FEATURE_WCG_BY_COLOR_MODE = 0x00100000,
	DRM_DISP_FEATURE_WCG_DP_OFF_HDR_DS = 0x00200000,
};
...
enum MTK_PLANE_MODE {
	MTK_PLANE_HWC,
	MTK_PLANE_SIDEBAND,
	MTK_PLANE_REPLACE_LAYER,
	MTK_PLANE_REPLACE_LAYER_2,
};
...
enum mtk_pq_module_type {
	...
	MTK_DISP_PQ_C3D,
	MTK_DISP_PQ_TDSHP,
	MTK_DISP_PQ_DMDP_AAL,
	MTK_DISP_PQ_ODDMR,
	MTK_DISP_VIRTUAL_TYPE,
	MTK_DISP_PQ_DBI_COUNT,
	MTK_DISP_PQ_CCORR_LINEAR,
	MTK_DISP_PQ_CCORR_NONLINEAR,
	MTK_DISP_PQ_C3D9,
	MTK_DISP_PQ_C3D17,
	MTK_DISP_PQ_CHIST_AFTER_PQ,
	MTK_DISP_PQ_CHIST_BEFORE_PQ,
	MTK_DISP_PQ_CHIST_AFTER_PC,
	MTK_DISP_PQ_NUM,
...
enum mtk_pq_frame_cfg_cmd {
	...
	PQ_ODDMR_DBI_LOAD_PARAM = 800,
	PQ_ODDMR_DBI_LOAD_TB,
	PQ_ODDMR_DBI_ENABLE,
	PQ_ODDMR_DBI_DISABLE,
	PQ_ODDMR_DBI_REMAP_TARGET,
	PQ_ODDMR_DBI_REMAP_CHG,
	PQ_ODDMR_DBI_REMAP_ENABLE,
	PQ_ODDMR_DBI_REMAP_DISABLE,
	PQ_ODDMR_DBI_SET_GAIN_RATIO,
	PQ_ODDMR_DBI_LOAD_SCP_PARAM,
	PQ_ODDMR_DBI_GET_SCP_LIFECYCLE,
	PQ_ODDMR_DMR_BINSET_INIT,
	PQ_ODDMR_DMR_BINSET_CHG,
	PQ_ODDMR_DMR_REG_TUNING_INIT,
	PQ_ODDMR_DMR_REG_TUNING_ENABLE,
	PQ_ODDMR_OD_INIT,
	PQ_ODDMR_OD_ENABLE,
	PQ_ODDMR_OD_DISABLE,
	PQ_ODDMR_OD_LOAD_PARAM,
	PQ_ODDMR_OD_WRITE_SW_REG,
	PQ_ODDMR_OD_USER_GAIN,
	PQ_ODDMR_DMR_CUS_BINSET_INIT,
	PQ_ODDMR_DMR_CUS_SETTING_INIT,
	PQ_ODDMR_DMR_CUS_OWN_DATA_INIT,
	PQ_ODDMR_OD_DEINIT,
	PQ_VIRTUAL_SET_PROPERTY = 900,
	PQ_VIRTUAL_CHECK_TRIGGER,
	PQ_VIRTUAL_RELAY_ENGINES,
	PQ_VIRTUAL_PAPER_MODE,
	PQ_VIRTUAL_SET_HW_RELAY,
	...
	PQ_DBI_COUNT_SET_COUNTING_MODE,
	/* Get cmd begin */
	/* Notice:
	...
	PQ_ODDMR_DMR_INIT = 60600,
	PQ_ODDMR_DMR_ENABLE,
	PQ_ODDMR_DMR_DISABLE,
	PQ_ODDMR_DBI_GET_HW_ID,
	PQ_ODDMR_DBI_GET_WIDTH,
	PQ_ODDMR_DBI_GET_HEIGHT,
	PQ_ODDMR_DBI_GET_DBV,
	...
	PQ_VIRTUAL_GET_PQ_CAPS,
	PQ_DBI_COUNT_GET_FENCE = 60800,
...
#define DRM_IOCTL_SET_PANEL_FEATURE          DRM_IOWR(DRM_COMMAND_BASE + \
	DRM_SET_PANEL_FEATURE, struct panel_param_info)
#define DRM_IOCTL_GET_PANEL_FEATURE          DRM_IOWR(DRM_COMMAND_BASE + \
	DRM_GET_PANEL_FEATURE, struct panel_param_info)
